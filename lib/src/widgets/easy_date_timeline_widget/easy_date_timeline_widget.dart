...
class _EasyDateTimeLineState extends State<EasyDateTimeLine> {
  ...
  void initState() {
    ...
    _easyYear =
        EasyDateUtils.convertDateToEasyYear(widget.initialDate, widget.locale);
        ...
        children: [
              ...
              child: Stack(
                children: [
                  ...
                  if (_showMonthPicker(pickerType: MonthPickerType.switcher))
                    EasyMonthSwitcher(
                      swticherStyle: EasyMonthSwitcherStyle.custom,
          ...
          TimeLineWidget(
            initialDate: initialDate.copyWith(
                month: _easyMonth.vale, day: _initialDay, year: _easyYear.vale),
  ...
  void _onMonthChange(EasyMonth? month, EasyYear? year) {
    setState(() {
      _initialDay = 1;
      _easyMonth = month!;
      _easyYear = year!;
